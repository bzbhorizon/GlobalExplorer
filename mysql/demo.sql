...
INSERT INTO `installations` VALUES ('GoogleEarth','128.243.19.179',49990,0,0,0,1,1,'explore the Earth from space'),('VisitorMonitor','128.243.19.182',49990,0,0,0,8,8,'null'),('Registration','128.243.19.182',49991,0,1,0,1,1,'introduce yourself'),('Art','128.243.19.178',49990,0,0,0,3,3,'handle objects from the keys you discovered'),('WorldMap','128.243.19.183',49990,0,0,2,8,8,'uncover hidden locations'),('PhotoWall','128.243.19.183',49991,0,0,0,1,1,'add your photos to the public display'),('Slideshow','128.243.19.180',49990,0,0,0,1,1,'view photos and information about the keys you discovered');
...
INSERT INTO `storylines` VALUES ('Art','WorldMap'),('WorldMap','Registration'),('Slideshow','WorldMap');
...
-- Dump completed on 2008-10-31 19:24:33
